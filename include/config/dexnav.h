...
#define DN_FLAG_DEXNAV_GET            DEXNAV_GET // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         DEXNAV_DETECTOR_MODE // Allow player to find hidden mons
#define DN_VAR_SPECIES                DEXNAV_REGISTERED_SPECIES // Registered DexNav species
#define DN_VAR_STEP_COUNTER           DEXNAV_STEP_COUNTER // Steps for finding hidden pokemon
